              ...
              data: (results) {
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final totalMarksObtained = result['totalMarksObtained'] ?? 0;
                    final status = result['status'] ?? 'Under Evaluation';
                    final isGraded = status.toString().toLowerCase() == 'graded';

                    final dateRaw = exam['date'];
                    final dateStr = dateRaw != null
                        ? DateTime.parse(dateRaw).toLocal().toString().split(' ').first
                        : 'N/A';
                    ...
                    return Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            onTap: isGraded && examId.toString().isNotEmpty

...
export const uploadQuestionPaper = async (req, res) => {
  try {
    console.log("[Question Paper] Incoming Frontend Data:", JSON.stringify(req.body, null, 2));
    ...
    console.error("[Question Paper Error] Uploading question paper failed:", error);

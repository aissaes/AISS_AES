...
const Login = () => {
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      ...
      // Fetch fresh profile state to update React Context immediately!
      const profileRes = await facultyAPI.getMe();
      const profile = profileRes.data.profile;
      
      // Pass the fully hydrated profile directly into Context
      login(profile);

      toast('Welcome back! Redirecting…', 'success');
      if      (role === 'collegeAdmin') navigate('/collegeadmin', { replace: true });
